...
@section('learn_section')
    ...
    <div class="container w-100">
        ...
        <div class="container top-2/4 flex flex-row flex-wrap flex-4 justify-start space-y-4 space-x-5 items-center overflow-x-hidden h-full">
            @foreach ($cards['values'] as $card)
                ...
                <div class="card lg:w-5/12 w-11/12 sm:w-full ml-5 p-5 sm:p-10 h-20 mt-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 text-white" >
    ...
    <div class="container z-1 w-[50%] max-lg:w-[92%] h-[60%]  bg-slate-100 border-2 border-grey-300 absolute top-[15%] left-[20%] max-lg:left-[5%]" >
        <div class="main p-10">
         ...
         @if ($result['success'])
            <div class="card text-center max-lg:w-5/12 w-12/12 max-sm:w-full  sm:p-10 h-20 mt-4 border-4 border-green-600 rounded-lg  dark:bg-gray-800 dark:border-gray-700" >
         ...
         @else  
         <div class="card text-center w-12/12 sm:w-full  sm:p-10 h-20 mt-4 border-4 border-red-600 rounded-lg  dark:bg-gray-800 dark:border-gray-700"  >
